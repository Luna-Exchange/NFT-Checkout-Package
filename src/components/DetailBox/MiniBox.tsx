  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative flex flex-col gap-0 justify-center items-center pt-2">
          <div className="relative flex flex-col w-full" style={{ minHeight: '180px', maxWidth: '325px' }}>
          ...
          <div
            className="flex items-start justify-end mb-2"
